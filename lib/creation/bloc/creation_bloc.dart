...
class CreationBloc extends Bloc<CreationEvent, CreationState> {
  ...
  Future<void> _onFirstNameChanged(
    ...
    try {
      emit(state.copyWith(status: ()=> CreationStatus.success, firstname: ()=> event.text));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  Future<void> _onLastNameChanged(
    ...
    try {
      emit(state.copyWith(status: ()=> CreationStatus.success, lastname: ()=> event.text));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  Future<void> _onBirthdayChanged(
    ...
    try {
      ...
      emit(state.copyWith(status: ()=> CreationStatus.success, birthday: ()=> date));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  Future<void> _onBirthplaceChanged(
    ...
    try {
      emit(state.copyWith(status: ()=> CreationStatus.success, birthplace: ()=> event.text));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  Future<void> _onNationalityChanged(
    ...
    try {
      emit(state.copyWith(status: ()=> CreationStatus.success, nationality: ()=> event.text));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  Future<void> _onAddressChanged(
    ...
    try {
      emit(state.copyWith(status: ()=> CreationStatus.success, address: ()=> event.text));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  Future<void> _onPhoneChanged(
    ...
    try {
      emit(state.copyWith(status: ()=> CreationStatus.success, phone: ()=> event.text));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  Future<void> _onEmailChanged(
    ...
    try {
      emit(state.copyWith(status: ()=> CreationStatus.success, email: ()=> event.text));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  ...
  Future<void> _onLanguageAdded(
    ...
    try {
      emit(state.copyWith(status: ()=> CreationStatus.success, languages: ()=> [...state.languages,...[event.language]]));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  ...
  Future<void> _onLanguageDeleted(
    ...
    try {
      ...
      emit(state.copyWith(status: ()=> CreationStatus.success, languages: ()=> tmp));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  ...
  Future<void> _onLicenseAdded(
    ...
    try {
      emit(state.copyWith(status: ()=> CreationStatus.success, licenses: ()=> [...state.licenses,...[event.license]]));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  ...
  Future<void> _onLicenseDeleted(
    ...
    try {
      ...
      emit(state.copyWith(status: ()=> CreationStatus.success, licenses: ()=> tmp));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  ...
  Future<void> _onAreaAdded(
    ...
    try {
      emit(state.copyWith(status: ()=> CreationStatus.success, areas: ()=> [...state.areas,...[event.area]]));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  ...
  Future<void> _onAreaDeleted(
    ...
    try {
      ...
      emit(state.copyWith(status: ()=> CreationStatus.success, areas: ()=> tmp));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  ...
  Future<void> _onPeriodAdded(
    ...
    try {
      ...
      emit(state.copyWith(status: ()=> CreationStatus.success, periods: ()=> [...state.periods,...[period]]));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
  ...
  Future<void> _onPeriodDeleted(
    ...
    try {
      ...
      emit(state.copyWith(status: ()=> CreationStatus.success, periods: ()=> tmp));
    } catch (e) {
      emit(state.copyWith(status: ()=> CreationStatus.failure));
    }
  }
